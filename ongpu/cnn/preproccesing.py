...
np.savez_compressed(dataset_path + 'images-224.npz', x, allow_pickle=False)
np.savez_compressed(dataset_path + 'labels-224.npz', y, allow_pickle=False)
...
np.savez_compressed(dataset_path + 'images-224-flipped.npz', x, allow_pickle=False)
np.savez_compressed(dataset_path + 'labels-224-flipped.npz', y, allow_pickle=False)

del x
del y

x, y = get_image_arrays(dataset_path + 'images-224-removed\\', breeds)
np.savez_compressed(dataset_path + 'images-224-removed.npz', x, allow_pickle=False)
np.savez_compressed(dataset_path + 'labels-224-removed.npz', y, allow_pickle=False)
x = np.array(x)
y = np.array(y)
...
np.savez_compressed(dataset_path + 'images-224-flipped-removed.npy', x, allow_pickle=False)
np.savez_compressed(dataset_path + 'labels-224-flipped-removed.npy', y, allow_pickle=False)
x = np.array(x)
y = np.array(y)
...
np.savez_compressed(dataset_path + 'images-224-s&p-noise.npy', x, allow_pickle=False)
np.savez_compressed(dataset_path + 'labels-224-s&p-noise.npy', y, allow_pickle=False)
x = np.array(x)
y = np.array(y)
...
np.savez_compressed(dataset_path + 'images-224-s&p-noise-flipped.npy', x, allow_pickle=False)
np.savez_compressed(dataset_path + 'labels-224-s&p-noise-flipped.npy', y, allow_pickle=False)
x = np.array(x)
y = np.array(y)
